...
const Dashboard: React.FC = () => {
    ...
    // Simple translation fallback (no context needed)
    const t = (key: string) => {
        const translations: Record<string, string> = {
            'home.dashboard.status.pending': 'Pendiente',
            'home.dashboard.status.approved': 'Aprobado',
            'home.dashboard.status.rejected': 'Rechazado',
            'home.dashboard.status.needs_fix': 'Necesita corrección',
            'home.dashboard.user.favoritePlaces': 'Lugares Favoritos',
            'home.dashboard.user.writtenReviews': 'Reseñas Escritas',
            'home.dashboard.user.myFavorites': 'Mis Favoritos',
        };
