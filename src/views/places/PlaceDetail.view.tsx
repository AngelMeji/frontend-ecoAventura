...
const PlaceDetail: React.FC = () => {
    ...
    const loadPlace = async (placeId: string) => {
        try {
            ...
            // Handle wrapped response from Laravel Resource (data.data)
            const loadedPlace = data.data || data;

            // V2: Public routes might not parse Sanctum Bearer tokens reliably without middleware.
            // When a user is logged in, we explicitly check their favorites.
            if (user) {
                try {
            ...
            <main className="container mx-auto px-4 py-8 max-w-5xl">
                ...
                <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100">
                    ...
                    <div className="relative h-[400px] md:h-[500px] bg-gray-200 group">
                        <SafeImage
                            src={(images[currentImageIndex] as any).full_url || getOptimizedImageUrl((images[currentImageIndex] as any).path || (images[currentImageIndex] as any).image_path)}
                            alt={place.name}
