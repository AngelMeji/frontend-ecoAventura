...
const HeroSection: React.FC = () => {
    return (
        <section 
            className="relative w-full h-[400px] md:h-[500px] rounded-[1.5rem] overflow-hidden mt-4 max-w-[1300px] mx-auto border border-gray-100 shadow-[0_4px_25px_rgba(0,0,0,0.05)]"
        ...
        >
            ...
            <div className="relative h-full flex flex-col justify-center px-10 md:px-20 max-w-3xl">
                ...
                <div>
                    <button 
                        className="bg-[#E9C46A] hover:bg-[#d4b05b] text-[#1f2937] font-bold py-3.5 px-8 rounded-full inline-flex items-center gap-2 transition-all hover:-translate-y-1 shadow-lg shadow-black/20 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[#E9C46A] focus-visible:ring-opacity-50" 
